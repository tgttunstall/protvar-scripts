...
```
./biogrid_fetch_hformat.sh -u https://downloads.thebiogrid.org/Download/BioGRID/Release-Archive/BIOGRID-4.4.240 -f BIOGRID-ALL-4.4.240.mitab.zip -o biogrid_human_interactions.txt --time --clean=txt
```
...
```
./plot_venn.py --files $DATA_DIR/af2-models-split-ifresid_.tsv $DATA_DIR/updated_suppl_ppi.tsv \
    --key_column interaction_id \
    --labels Updated_Suppl_ppi AF2  \
    --plot_title "Comparison of AF2 and updated_Suppl_ppi " \
    --output_file $DATA_DIR/venn_AF2_updatedSuppl_ppi.png \
    --verbose
```
**Note:**
...
![venn3_af2_suppl_bg](https://github.com/user-attachments/assets/e06721aa-61e0-4a94-932b-d831a99e7ae4)
